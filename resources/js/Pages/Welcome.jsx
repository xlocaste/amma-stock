        ...
        <>
            ...
            <div className="relative min-h-screen bg-gray-100 text-gray-800">
                        ...
                        <nav className="flex items-center space-x-4">
                            {auth.user ? (
                                ...
                                <>
                                    ...
                                    <Link
                                        href={route("register")}
                                        className="rounded-lg px-5 py-2.5 text-sm font-medium text-gray-900 bg-white transition hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
                                    >
                                        Get Started
                                    </Link>
                                </>
                ...
                <main className="relative z-10 flex items-center justify-center min-h-[calc(100vh-80px)]">
                    <div className="text-center text-white px-6 py-12 sm:px-12 sm:py-16 lg:px-16">
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
                            Solusi POS Terbaik untuk Bisnis Kopi Anda
                        </h1>
                        <p className="text-lg sm:text-xl lg:text-2xl mb-10 max-w-3xl mx-auto text-gray-200">
